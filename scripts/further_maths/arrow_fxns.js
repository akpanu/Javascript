// 1. linear series
const linear_series = (a, d, n) => {
  const sn = (1 / 2) * n * (2 * a + (n - 1) * d)
  return sn
}

// 2. geometric series
const geo_series = (a, n, r) => {
